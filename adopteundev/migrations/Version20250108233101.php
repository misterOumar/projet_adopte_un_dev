 ...
 */
final class Version20250108233101 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, poste_id INT DEFAULT NULL, developer_id INT NOT NULL, fichier_id INT NOT NULL, date DATE NOT NULL, statut VARCHAR(15) NOT NULL, reponse VARCHAR(255) DEFAULT NULL, INDEX IDX_E33BD3B8A0905086 (poste_id), INDEX IDX_E33BD3B864DD9267 (developer_id), INDEX IDX_E33BD3B8F915CFE (fichier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE developer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, cat_id INT NOT NULL, nom VARCHAR(80) NOT NULL, prenom VARCHAR(180) NOT NULL, mobile VARCHAR(10) NOT NULL, salaire_min DOUBLE PRECISION DEFAULT NULL, is_disponible TINYINT(1) DEFAULT NULL, experience INT DEFAULT NULL, ville VARCHAR(180) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, biographie LONGTEXT DEFAULT NULL, mobile_visible TINYINT(1) NOT NULL, salaire_visible TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_65FB8B9AA76ED395 (user_id), INDEX IDX_65FB8B9AE6ADA943 (cat_id), UNIQUE INDEX UNIQ_MOBILE (mobile), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
