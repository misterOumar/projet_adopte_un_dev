 ...
 */
final class Version20250106184449 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidature (id INT AUTO_INCREMENT NOT NULL, poste_id INT DEFAULT NULL, developer_id INT NOT NULL, date DATE NOT NULL, statut VARCHAR(15) DEFAULT "En cours" NOT NULL, reponse VARCHAR(255) DEFAULT NULL, INDEX IDX_E33BD3B8A0905086 (poste_id), INDEX IDX_E33BD3B864DD9267 (developer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
