 ...
 */
final class Version20250107200755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE developer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, cat_id INT NOT NULL, nom VARCHAR(80) NOT NULL, prenom VARCHAR(180) NOT NULL, mobile VARCHAR(10) NOT NULL, salaire_min DOUBLE PRECISION DEFAULT NULL, is_disponible TINYINT(1) NOT NULL, experience INT DEFAULT NULL, ville VARCHAR(180) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, biographie LONGTEXT DEFAULT NULL, mobile_visible TINYINT(1) NOT NULL, salaire_visible TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_65FB8B9AA76ED395 (user_id), INDEX IDX_65FB8B9AE6ADA943 (cat_id), UNIQUE INDEX UNIQ_MOBILE (mobile), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
